...
public class _03frogJump {

    public static void main(String[] args) {
        // int n = 4;
        // int [] arr = {10, 20, 30, 10};
        int n = 97;
        // String ss = "27 35 43 34 27 19 7 38 16 18 46 13 14 50 34 38 36 34 26 39 6 41 23 1 33 30 45 13
        //  47 13 22 20 3 1 17 26 45 39 22 45 21 11 30 44 36 45 29 27 39 42 40 35 46 31 21 6 31 50 20 50
        //  10 10 24 6 30 29 44 39 42 14 23 12 4 1 35 5 45 40 44 42 47 24 48 16 21 50 34 4 13 5 36 46 20 
        // 45 3 13 7";
        String[] st = ss.split(" ");
        int[] arr = new int[n];
        int i = 0;
...
//Tabulation solution - (Tc - 0(n) Sc - 0(N))
    public static int solveTabu(int n, int[] arr, int[] dp) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            int diff2 = Integer.MAX_VALUE;
            if (i > 1)
                diff2 = dp[i - 2] + Math.abs(arr[i] - arr[i - 2]);
...
//Tabulation solution - (Tc - 0(n) Sc - 0(1))
    public static int solveSpaceOpti(int n, int[] arr) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            int diff2 = Integer.MAX_VALUE;
            if (i > 1)
                diff2 = prev2 + Math.abs(arr[i] - arr[i - 2]);
            prev2 = prev1;
