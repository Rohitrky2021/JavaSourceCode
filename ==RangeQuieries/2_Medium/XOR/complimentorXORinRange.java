...
// M1 if do with BruteForce -->is O(n^2).  
// for (int i = 1; i > a >> b;
//     for (int j = a; j <= b; j++)
//         arr[j] ^= 1;
// ============================================================================
// But by our M2--> approach is O(n). Auxiliary Space: O(1)
// After all commands we will process the array as arr[i] ^= arr[i-1]; 
public class complimentorXORinRange {

    // function for toggle-------------------------------->or SIMPLY COMPLIMENT 
