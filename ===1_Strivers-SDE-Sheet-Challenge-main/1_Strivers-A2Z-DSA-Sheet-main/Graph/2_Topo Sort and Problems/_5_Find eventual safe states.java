...
public class find_Eventual_Safe_States {
    ...
    //  M 1 -- > BFS
        ...
        List<Integer> eventualSafeNodes1(int n, List<List<Integer>> adj) {
            ...
            for(int i = 0; i < n; i++){  // Reversing the Direction of Arrow Step To start from Terminal Nodes
    ...
    public static List<Integer> eventualSafeNodes(int n, List<List<Integer>> adj) {
        int vis[] = new int[n]; // Array to mark visited nodes
        int pathVis[] = new int[n]; // Array to mark nodes visited in the current path
        int check[] = new int[n]; // Array to mark nodes as safe (1) or unsafe (0)
