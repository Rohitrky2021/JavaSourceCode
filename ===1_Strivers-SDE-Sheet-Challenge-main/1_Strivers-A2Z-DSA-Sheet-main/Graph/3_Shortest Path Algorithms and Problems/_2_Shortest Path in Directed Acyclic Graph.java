...
// This is single-source shortest path algorithm (SSSP) are preferred because they can achieve better time complexity.
//  These algorithms run in O(V+E) time, where V is the number of vertices and E is the number of edges
// We take advantage of the fact that the graph is a Directed Acyclic Graph (DAG) 
// and use a topological sort to order the vertices in a linear fashion.
	...
	public static int[] shortestPath(int n,int m, int[][] edges) {
		...
		while(!st.isEmpty()){
		    ...
		    for(Pair it : adj.get(node)){
				...
				// Similar like Dijsktr & Bellman But Different 
