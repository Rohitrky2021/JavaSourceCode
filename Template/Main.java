...
/* 
Sure, here is a list of functions and classes used in the provided Java code snippet:
...
ArrayList<Integer> distinctPrimeFactors(int n)
ArrayList<Long> distinctPrimeFactors(long n)
...
pair(int a, int b)
void solveTheProblem(InputReader in, OutputWriter out, NumberTheory nt, Debug dbg)
void main(String[] args)
void setLocal(int a)
String ts(T t)
String ts(T[] arr)
String ts(Iterable<T> iter)
void dbg(Object... o)
...
boolean isExhausted()
String next()
SpaceCharFilter getFilter()
void setFilter(SpaceCharFilter filter)
int[] nextIntArray(int n)
int[] nextSortedIntArray(int n)
ArrayList<Integer> nextIntArrayList(int n)
ArrayList<Long> nextLongArrayList(int n)
int[] nextSumIntArray(int n)
long[] nextLongArray(int n)
long[] nextSumLongArray(int n)
long[] nextSortedLongArray(int n)
...
void print(int i)
void println(int i)
void separateLines(int[] array)
ProblemSolver()
NumberTheory()
InputReader(InputStream stream)
OutputWriter(OutputStream outputStream)
Please note that the list includes both methods from the provided code and methods/classes 
that are likely part of the standard library or custom utility classes.
*/
  ...
  static class Debug {
    ...
    public void setLocal(int a) {
      if (a == 1)
        ...
        LOCAL = System.getProperty("user.home").toString().equals("C:\\Users\\Hp");
    }
