 ...
 * 
 * Where 'N' is the length of the given array and 'M' the maximum value in the
 * array.
 */
public class Solution {
    public static Trie insert(Trie root, int n) {
        ...
        while (i < 32) {
            ...
            if (temp.children[num] != null) // Do index he hai 0 ya 1 unpar he jaake nya bun jaayega 0>Left and 1->Right
                ...
                temp.children[num] = new Trie(); // 0 ya 1 index p new 2 array form ho jaayega for the Last 32 th but in
                                                 // start
                temp = temp.children[num];
            }
            i++;
