...
public abstract class inorder{
    ...
    static class binaryTree{
        ...
        public static void levelOrder(Node root){
            ...
            if(currnode==null){
                ...
                if(currnode.left!=null) {q.add(currnode.left); System.out.print("L  ");}
                if(currnode.right!=null){ q.add(currnode.right); System.out.print("R  ");}
            }
    ...
    public static void main (String args[]){
        int nodes[]={1,2,4,-1,-1,5,-1,-1,3,-1,6,-1,9,-1,7,-1,8,-1,-1};
